      ...
      >
        ...
        >
          <div className="nav-drop-wrapper">
            <div className="nav-drop-wrapper__left">
              <ul>
            ...
            <div className="nav-drop-wrapper__right">
              <div className="promo-banner">
                <div className="image-container">{this.props.name}</div>
                <div>
                  <span>Shop {this.props.name}</span>
                </div>
              </div>
              <div className="promo-banner">
                <div className="image-container">{this.props.name}</div>
